<template>
  <div class="meta-input rounded-md border bg-white p-4 dark:bg-gray-800">
    <a-tabs>
      <!-- Basic Settings -->
      ...
      <!-- Visibility Settings -->
      <a-tab-pane key="visibility" :tab="'可见性设置'">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <!-- Tab Settings -->
      <a-tab-pane key="tab" :tab="'标签页设置'">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          <a-form-item :label="$t('system.menu.keepAlive')" class="flex items中心">
      ...
      <!-- Navigation Settings -->
      <a-tab-pane key="navigation" :tab="'导航设置'">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
